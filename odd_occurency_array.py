...
# Note: to be honest john's solution (https://github.com/johnmee/codility/blob/master/ex-2-2-oddoccurencesinarray.py)
# is more easier to write, more readable, more elengant and easier to mantain then mine. Long live hashes.
...
def solution(A):
    ...
    candidate = None
    last_valid = None
    for i in range(0, len(a_sort) - 1, 2):
        last_valid = i + 2

        if a_sort[last_valid] != a_sort[i + 1]:
            candidate = a_sort[last_valid]
